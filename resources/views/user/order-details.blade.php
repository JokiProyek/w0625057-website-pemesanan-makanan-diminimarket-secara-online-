                        ...
                        <div class="flex items-center justify-between gap10 flex-wrap">
                            <div class="row">
                                ...
                                <div class="col-6 text-right">
                                    <a class="tbtn btn-sm btn-danger" href="{{route('user.orders')}}">Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-bordered teble-striped table-transaction">
                                <tr>
                                    <th>Order No</th>
                                    <td>{{$order->id}}</td>
                                    <th>Table Number</th>
                                ...
                                <tbody>
                                    @foreach($orderItems as $item)
                                        <tr>
                                            <td class="pname">
                                                <div class="image">
                                                    <img src="{{ asset('upload/products/thubnails') }}/{{ $item->product->image }}"
                                            ...
                                            <td class="text-center">{{ $item->product->vendor->name }}</td>
